(function () {
    ...
    function shuffleTiles() {
        ...
        ds.getCount().then(function (count) {
            if (count > 0) {
    ...
    WinJS.Namespace.define("Scenario3Name", {
        initialize: function () {
            WinJS.UI.processAll();

            document.querySelector("#scenario3Input #shuffle").addEventListener("click", shuffleTiles, false);
            document.querySelector("#scenario3Input #removeSelected").addEventListener("click", removeSelected, false);
            document.querySelector("#scenario3Input #swapSelected").addEventListener("click", swapSelected, false);
            document.querySelector("#scenario3Input #addTile").addEventListener("click", addTile, false);
